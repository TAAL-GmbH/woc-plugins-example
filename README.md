...
A set of example decoders to show how decoder plugins can can be created.
...
3. Run `cp .env.template .env` (Add your openAI key to the the .env file if you wish to run the openAI example)
...
## Example of Integrating plugin to whatsonchain.com
